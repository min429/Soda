...
object TextMatchingHelper {
    fun textMatch(category: Category): String{
        ...
        label = when(category.label) {
            "Speech" -> "말하는 소리 같습니다."
            "Child speech, kid speaking" -> "어린이가 말하는 소리 같습니다."
            ...
            "Police car (siren)" -> "사이렌 소리 같습니다."
            "Ambulance (siren)" -> "사이렌 소리 같습니다."
            "Fire engine, fire truck (siren)" -> "사이렌 소리 같습니다."
            "Motorcycle" -> "오토바이 소리 같습니다."
            "Traffic noise, roadway noise" -> "교통 소음, 도로 소음 소리 같습니다."
            "Rail transport" -> "철도 운송 소리 같습니다."
            "Train" -> "기차 소리 같습니다."
            "Train whistle" -> "기차 휘파람(출발 알림) 소리 같습니다."
            ...
            "Buzzer" -> "경보 소리 같습니다."
            "Smoke detector, smoke alarm" -> "경보기 소리 같습니다."
            ...
            "Thump, thud" -> "물체가 부딪치거나 떨어지는 소리같습니다."
            "Thunk" ->"물체가 둔하게 부딪치는 소리같습니다."
            ...
            "Outside, urban or manmade" -> "도시 외부의 소리 같습니다."
            "Outside, rural or natural" -> "시골의 외부 소리 같습니다."
